...
Helper Files
school.c: C function that displays a seahorse in text. Used for Makefile practice purposes throughout project. Provided by Holberton School.
...
3-Makefile: Makefile that creates an executable holberton based on school.c and main.c. Builds on 2-Makefile with:
...
100-Makefile: Makefile that creates an executable holberton based on school.c and main.c. Builds on 4-Makefile with:
